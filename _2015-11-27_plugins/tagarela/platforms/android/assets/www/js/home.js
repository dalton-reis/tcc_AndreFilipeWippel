$(document).ready(function() {
    ...
    function okQueryFotoHome(tx, results) {
        ...
        for (var i=0; i<len; i++) {
	    	$(".foto-img").html("<img src='"+results.rows.item(i).img+"' title='"+results.rows.item(i).audio+"' alt='' class='left' style='margin:25px' height='175' width='175' />");
	    }
    ...
    function okQuerySimbHome(tx, results) {
        ...
        for (var i=0; i<len; i++) {
	    	$(".builders").append("<li><a href='builder.html'>"
								 +"<img src='"+results.rows.item(i).img+"' title='"+results.rows.item(i).audio+"' alt='"+results.rows.item(i).usuid+"' class='foto-builder' style='margin-bottom:13px' height='175' width='175' />"
								 +"</a></li>");
	    }
	    $(".foto-builder").click(function() {
			var alt = $(this).attr("alt");
