$(document).ready(function() {
	...
	function okQuerySimbPranchasPlanoFil(tx, results) {
        ...
        for (var i=0; i<len; i++) {
	    	$(".pranchas").append("<li style='display:inline-block'><a href='#'>"
								 +"<img src='../img/"+results.rows.item(i).img+"' title='"+results.rows.item(i).audio+"' alt='"+results.rows.item(i).prancha+"' class='img-prancha' style='margin:20px' height='150' width='150'/>"
								 +"</a></li>");
	    }
	    $(".img-prancha").click(function reutilizarPrancha() {
			var alt = $(this).attr("alt");
	...
	function okQuerySimbPranchaFil(tx, results) {
		...
		switch (cont) {
			case 0:
				localStorage.simb1 = "../img/"+ximg;
				localStorage.idSimb1 = xid;
				break;
			case 1:
				localStorage.simb2 = "../img/"+ximg;
				localStorage.idSimb2 = xid;
				break;
			case 2:
				localStorage.simb3 = "../img/"+ximg;
				localStorage.idSimb3 = xid;
				break;
			case 3:
				localStorage.simb4 = "../img/"+ximg;
				localStorage.idSimb4 = xid;
				break;
			case 4:
				localStorage.simb5 = "../img/"+ximg;
				localStorage.idSimb5 = xid;
				break;
			case 5:
				localStorage.simb6 = "../img/"+ximg;
				localStorage.idSimb6 = xid;
				break;
			case 6:
				localStorage.simb7 = "../img/"+ximg;
				localStorage.idSimb7 = xid;
				break;
			case 7:
				localStorage.simb8 = "../img/"+ximg;
				localStorage.idSimb8 = xid;
				break;
			case 8:
				localStorage.simb9 = "../img/"+ximg;
