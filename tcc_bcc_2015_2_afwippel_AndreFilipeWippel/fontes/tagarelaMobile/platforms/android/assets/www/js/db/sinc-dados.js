...
function consTabelas(tx) {
	...
	if (localStorage.dinamico == "iOS") {
		...
		/*tx.executeSql('DROP TABLE IF EXISTS simbolos ');
		tx.executeSql('CREATE TABLE IF NOT EXISTS simbolos (id INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT, nome TEXT, significado TEXT, categoria INTEGER, img TEXT, audio TEXT, sinc INTEGER)');
		tx.executeSql('INSERT INTO simbolos (nome, significado, categoria, img, audio, sinc) VALUES ("Rodrigo", "Fonoaudiólogo", 1, "file:///android_asset/www/img/pessoas-amarelo/rodrigo-fonoaudiologo.png", "file:///android_asset/www/audio/pessoas-amarelo/Rodrigo.mp3", 0)');
		tx.executeSql('INSERT INTO simbolos (nome, significado, categoria, img, audio, sinc) VALUES ("Dalton", "Pai e Tutor", 1, "file:///android_asset/www/img/pessoas-amarelo/dalton-pai.png", "file:///android_asset/www/audio/pessoas-amarelo/Dalton.mp3", 0)');
		tx.executeSql('INSERT INTO simbolos (nome, significado, categoria, img, audio, sinc) VALUES ("Giovanna", "", 1, "file:///android_asset/www/img/pessoas-amarelo/giovanna-paciente.png", "file:///android_asset/www/audio/pessoas-amarelo/Giovana.mp3", 0)');
		tx.executeSql('INSERT INTO simbolos (nome, significado, categoria, img, audio, sinc) VALUES ("Gabriel", "", 1, "file:///android_asset/www/img/pessoas-amarelo/gabriel-irmao.png", "file:///android_asset/www/audio/pessoas-amarelo/Gabriel.mp3", 0)');
		tx.executeSql('INSERT INTO simbolos (nome, significado, categoria, img, audio, sinc) VALUES ("Necessidades Básicas", "Possui as pranchas de necessidades básicas", 0, "file:///android_asset/www/img/substantivos-vermelho/banheiro.png", "file:///android_asset/www/audio/interface-preto/Apoio.mp3", 0)');
		tx.executeSql('INSERT INTO simbolos (nome, significado, categoria, img, audio, sinc) VALUES ("Atividades Físicas", "Pranchas das atividades físicas", 0, "file:///android_asset/www/img/verbos-verde/andar-cavalo.png", "file:///android_asset/www/audio/interface-preto/Apoio.mp3", 0)');
		tx.executeSql('INSERT INTO simbolos (nome, significado, categoria, img, audio, sinc) VALUES ("Rose", "Pedagoga", 1, "file:///android_asset/www/img/pessoas-amarelo/rose-prof-pedagoga.png", "file:///android_asset/www/audio/pessoas-amarelo/Professora.mp3", 0)');
		tx.executeSql('INSERT INTO simbolos (nome, significado, categoria, img, audio, sinc) VALUES ("Prancha - Beber", "", 0, "file:///android_asset/www/img/verbos-verde/beber.png", "file:///android_asset/www/audio/verbos-verde/Beber.mp3", 0)');
		tx.executeSql('INSERT INTO simbolos (nome, significado, categoria, img, audio, sinc) VALUES ("Prancha - Tomar Banho", "", 0, "file:///android_asset/www/img/verbos-verde/tomar-banho.png", "file:///android_asset/www/audio/substantivos-vermelho/Banho.mp3", 0)');
		tx.executeSql('INSERT INTO simbolos (nome, significado, categoria, img, audio, sinc) VALUES ("Beber", "", 3, "file:///android_asset/www/img/verbos-verde/beber.png", "file:///android_asset/www/audio/verbos-verde/Beber.mp3", 0)');
		tx.executeSql('INSERT INTO simbolos (nome, significado, categoria, img, audio, sinc) VALUES ("Tomar Banho", "", 3, "file:///android_asset/www/img/verbos-verde/tomar-banho.png", "file:///android_asset/www/audio/substantivos-vermelho/Banho.mp3", 0)');
		tx.executeSql('INSERT INTO simbolos (nome, significado, categoria, img, audio, sinc) VALUES ("Água", "", 2, "file:///android_asset/www/img/substantivos-vermelho/agua.png", "file:///android_asset/www/audio/substantivos-vermelho/Agua.mp3", 0)');
		tx.executeSql('INSERT INTO simbolos (nome, significado, categoria, img, audio, sinc) VALUES ("Prancha - Brincar", "", 0, "file:///android_asset/www/img/verbos-verde/brincar.png", "file:///android_asset/www/audio/verbos-verde/Brincar.mp3", 0)');
		tx.executeSql('INSERT INTO simbolos (nome, significado, categoria, img, audio, sinc) VALUES ("Brincar", "", 3, "file:///android_asset/www/img/verbos-verde/brincar.png", "file:///android_asset/www/audio/verbos-verde/Brincar.mp3", 0)');
		tx.executeSql('INSERT INTO simbolos (nome, significado, categoria, img, audio, sinc) VALUES ("Fantoches", "", 2, "file:///android_asset/www/img/substantivos-vermelho/fantoches.png", "file:///android_asset/www/audio/substantivos-vermelho/Fantoches.mp3", 0)');*/
	}
...
function consLog(tx) {
	tx.executeSql("SELECT id,builder,prancha,data_hora,atividade,sinc FROM log WHERE sinc <> 0", [], okConsLogs, nokTransSinc);
}
function okConsLogs(tx, results) {
    ...
    for (var i=0; i<len; i++) {
    	var dados = {
			"id" : results.rows.item(i).id,
			"builder" : results.rows.item(i).builder,
			"prancha" : results.rows.item(i).prancha,
	    ...
	    success  : function(ret) {
	    	if (ret.erro) {
		    	...
		    	for	(var i = 0; i < ret.logsBuilder.length; i++) {
					...
					logsPrancha[i] = ret.logsPrancha[i];
...
function localLogs(tx) {
	...
	for	(var i = 0; i < logsBuilder.length; i++) {
		tx.executeSql("INSERT INTO log (builder,prancha,data_hora,atividade,sinc) VALUES (?,?,?,?,0)", [logsBuilder[i],logsPrancha[i],logsDatahora[i],logsAtividade[i]]);
	}
}
...
function localSimbolos(tx) {
	...
	for	(var i = (simbolosNome.length-1); i >= 0; i--) {
