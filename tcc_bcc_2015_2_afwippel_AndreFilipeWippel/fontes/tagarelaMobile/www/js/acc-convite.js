    ...
    function okQueryAccSimb(tx, results) {
        ...
        for (var i=0; i<len; i++) {
	    	...
	    	if (localStorage.dinamico == "iOS") {
	    		$(".pacientes").append("<a href='mostrar-convite.html'>"
								  +"<img src='../img/"+results.rows.item(i).img+"' title='"+results.rows.item(i).audio+"' alt='"+idPac+"' class='img-paciente' style='margin:25px; border:10px solid "+corBorda+"' height='175' width='175'/>"
							 	  +"</a>");
	    	}
	    	else {
	    		$(".pacientes").append("<a href='mostrar-convite.html'>"
								  +"<img src='"+results.rows.item(i).img+"' title='"+results.rows.item(i).audio+"' alt='"+idPac+"' class='img-paciente' style='margin:25px; border:10px solid "+corBorda+"' height='175' width='175'/>"
							 	  +"</a>");
			}
		}
		$(".img-paciente").click(function() {
