	   		...
	   		if (ret.erro) {
				...
				for	(var i = 0; i < ret.buildersId.length; i++) {
					...
					$(".builders").append("<li><a href='builder.html'>"
										     +"<img src='img/"+ret.buildersImg[i]+"' title='"+ret.buildersAudio[i]+"' alt='"+ret.buildersId[i]+"' class='foto-builder' style='margin-bottom:13px; border:10px solid "+corBordaBuilder+"' height='175' width='175' />"
										 +"</a></li>");
				}
		    }
	    },
